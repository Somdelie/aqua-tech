...
const productTypes = [
  ...
  { value: "GAMING_PC", label: "Gaming PC", icon: Laptop },
  { value: "GAMING_LAPTOP", label: "Gaming Laptop", icon: Laptop },
  { value: "PRINTER", label: "Printer", icon: Monitor },
  { value: "SCANNER", label: "Scanner", icon: Monitor },
