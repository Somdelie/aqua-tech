...
export function ImageInput({
  ...
  return (
    <div className="flex flex-col space-y-3 w-full">
      ...
      <div
        className="border-dashed border-2 border-primary/30 rounded p-4 py-2 flex flex-col items-center justify-center w-full hover:bg-gray-200 transition duration-200 ease-in-out cursor-pointer"
